...
<body>
  ...
  <a href="custbookings.php" class="active">My bookings</a>
...
$conn = mysqli_connect('localhost', 'root','', 'project');
	$query1="SELECT o.order_id as oid,o.date as date,o.customer_id  as cid,c.first_name as cfname,c.last_name as clname,c.phone as cphone,c.email as cemail,o.fundi_id as fid,f.first_name as ffname,f.last_name as flname,f.phone as fphone,f.email as femail,o.specific_location as location,o.task as task,o.amount as amount,o.payment_status as pstatus from orders o join customer c on(o.customer_id=c.id) join fundi f ON(o.fundi_id=f.id) where c.id=$custid and o.task_status='unfinished' or o.payment_status='unpaid' order by o.order_id DESC";
  ...
  <tr id="income"><th>ACTIVE BOOKINGS</th></tr>

      </table>';
    
 
	echo ' <table id="table" class="table ordered">
<tr>
<th>Order ID</th>
<th>Order Date</th>
<th>Fundi Names</th>
...
echo'</tr>';  
  ...
  echo '<div id="rec">You have no active bookings</div>';
}
  	?>
</div>
<footer>
