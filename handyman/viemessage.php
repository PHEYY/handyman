    ...
    echo'<form  method="POST" enctype="multipart/form-data">
              <fieldset>
                ...
                <label><span class="text-form">Full Name:</span>
                  <input type="text" name="full_name" value="'.$row1['full_name'].'" required>
                </label>
              </div>
                <div>
                  
                <label><span class="text-form">E-mail:</span>
                  <input type="text" name="email" value="'.$row1['email'].'" required>
                </label>
              </div>
              <div>
                <label><span class="text-form">Telephone:</span>
                  <input type="text" name="telephone" value="'.$row1['telephone'].'" required>
                </label>
              </div>
                <div >
                   <label> Message:</label>
                    <textarea name="message" style="height: 200px; width: 90%" value="'.$row1['message'].'" required></textarea>
                  </div>
