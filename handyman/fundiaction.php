...
$loc=$_POST['loc'];
 ...
 $query="select * from fundi where id= $fundiid";
...
$years=$row["years"];
      ...
      <form method="POST" action="fundis.php" >
...
<div >
  ...
  <input id="" type="text" name="fundi" value="'.$fundi.'">
<input id="" type="text" name="loc" value="'.$loc.'">
  </div>
</form>';
}
