...
<div class="topnav" id="myTopnav">
 <a class="active" href="adminpg1.php">home</a>
  ...
  <div class="parent">
    <form method="POST" id="date" required>
...
$query1="SELECT o.order_id as oid, o.date as date, o.customer_id  as cid,c.first_name as cfname,c.last_name as clname,c.phone as cphone,c.email as cemail,o.fundi_id as fid,f.first_name as ffname,f.last_name as flname,f.phone as fphone,f.email as femail, o.payment_status as pstatus from orders o join customer c on(o.customer_id=c.id) join fundi f ON(o.fundi_id=f.id) where date between '$from'and '$to' and payment_status='paid' and task_status='finished' order by order_id DESC";
  $result1=mysqli_query($conn,$query1); 
while($row1=mysqli_fetch_array($result1)){
echo '<tr>';
echo '<td>'.$row1["oid"].'</td>';
