...
$query="select * from contactus where status='$mess' and monthname(date)='$month' and year(date)=$year";
$result=mysqli_query($conn,$query);
$rowcheck=mysqli_num_rows($result);
if ($rowcheck>0) {
 echo'<table <tr><th id="head">'.$mess.' messages for '.$month.' '.$year.'<th><tr></table>';
   echo '<table class="table bordered" id="mess">
        <tr><th>Message Id</th>
            <th>Sent date</th>
             <th>Sender Name</th>
             <th>Sender email</th>
...
echo'<td><form method="POST" action="viewmessage.php">
         ...
         <input style="display:none;" type="text" name="no" value="'.$rows['no'].'">
         <input style="display:none;" type="email" name="email" value="'.$rows['email'].'">
         <input type="submit" name="view" value="Open message">
         </form>
...
echo '</tr>';
  ...
  echo'<div id="rec">There are no '.$mess.' messages for '.$month.' '.$year.'</div>';
}
