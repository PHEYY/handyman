...
if (isset($_POST['view'])) {
  ...
  echo'<style>
   ...
   echo '<div class="row"><div class="col-md-3"></div><div class="col-md-6" style="margin-top:5%; border: groove 2px;"><table class="table bordered" id="details">';
    echo '<tr>';
echo '<th class="th" style="color:maroon; font-size=1.25em;">ORDER '.$row2["oid"].' DETAILS </th>';
echo '</tr></table>';
...
<b><input type="submit" name="submit" value="Back" ></b></form></td>';
echo'</tr>';  
  echo "</table></div></div>";
